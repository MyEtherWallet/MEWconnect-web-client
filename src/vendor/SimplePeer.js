  ...
  })()(
    {
        ...
        function(e, t, n) {
          ...
          function a(e) {
            for (
              ...
              (t =
                (p[e.charCodeAt(f)] << 18) |
                (p[e.charCodeAt(f + 1)] << 12) |
                (p[e.charCodeAt(f + 2)] << 6) |
                p[e.charCodeAt(f + 3)]),
                (s[l++] = 255 & (t >> 16)),
                (s[l++] = 255 & (t >> 8)),
                (s[l++] = 255 & t);
            return (
              2 === d &&
                ((t =
                  (p[e.charCodeAt(f)] << 2) | (p[e.charCodeAt(f + 1)] >> 4)),
                (s[l++] = 255 & t)),
              1 === d &&
                ((t =
                  (p[e.charCodeAt(f)] << 10) |
                  (p[e.charCodeAt(f + 1)] << 4) |
                  (p[e.charCodeAt(f + 2)] >> 2)),
                (s[l++] = 255 & (t >> 8)),
                (s[l++] = 255 & t)),
              s
            );
          ...
          for (
            var c = [],
              p = [],
              u = 'undefined' == typeof Uint8Array ? Array : Uint8Array,
              f =
      ...
      3: [
        function(e, t, n) {
          ...
          function p(e) {
            for (
              var t = 0 > e.length ? 0 : 0 | g(e.length), n = o(t), r = 0;
              r < t;
              r += 1
            )
              n[r] = 255 & e[r];
          ...
          function f(e) {
            ...
            if (e) {
              if (ArrayBuffer.isView(e) || 'length' in e)
                return 'number' != typeof e.length || G(e.length) ? o(0) : p(e);
              ...
              if (o + s <= n) {
                ...
                1 === s
                  ...
                  : 2 === s
                    ? ((l = e[o + 1]),
                      128 == (192 & l) &&
                        ((u = ((31 & a) << 6) | (63 & l)), 127 < u && (d = u)))
                    : 3 === s
                      ? ((l = e[o + 1]),
                        (c = e[o + 2]),
                        128 == (192 & l) &&
                          128 == (192 & c) &&
                          ((u = ((15 & a) << 12) | ((63 & l) << 6) | (63 & c)),
                          2047 < u && (55296 > u || 57343 < u) && (d = u)))
                      : 4 === s
                        ? ((l = e[o + 1]),
                          (c = e[o + 2]),
                          (p = e[o + 3]),
          ...
          function D(e, t, n, r, o) {
            return (
              (t = +t),
              (n >>>= 0),
              o || M(e, t, n, 4, 34028234663852886e22, -34028234663852886e22),
              $.write(e, t, n, r, 23, 4),
              n + 4
            );
          }
          function P(e, t, n, r, o) {
            return (
              (t = +t),
              (n >>>= 0),
              o || M(e, t, n, 8, 17976931348623157e292, -17976931348623157e292),
              $.write(e, t, n, r, 52, 8),
              n + 8
            );
          }
          ...
          (n.kMaxLength = 2147483647),
            ...
            (d.compare = function(e, t) {
              ...
              if (e === t) return 0;
              for (
                var n = e.length, r = t.length, o = 0, a = X(n, r);
                o < a;
                ++o
              )
                if (e[o] !== t[o]) {
            ...
            (d.concat = function(e, t) {
              ...
              for (n = 0; n < e.length; ++n) {
                var a = e[n];
                if ((ArrayBuffer.isView(a) && (a = d.from(a)), !d.isBuffer(a)))
                  throw new TypeError(
                    '"list" argument must be an Array of Buffers'
                  );
        ...
        function(e, t) {
          function n() {
            (this._events &&
              ...
              ((this._events = _(null)), (this._eventsCount = 0)),
          ...
          function a(e, t, n) {
            if (t) e.call(n);
              ...
              for (var r = e.length, o = h(e, r), a = 0; a < r; ++a)
                o[a].call(n);
          }
          function d(e, t, n, r) {
            if (t) e.call(n, r);
            else
              for (var o = e.length, a = h(e, o), d = 0; d < o; ++d)
                a[d].call(n, r);
          }
          function s(e, t, n, r, o) {
            if (t) e.call(n, r, o);
            else
              for (var a = e.length, d = h(e, a), s = 0; s < a; ++s)
                d[s].call(n, r, o);
          }
          function l(e, t, n, r, o, a) {
            if (t) e.call(n, r, o, a);
            else
              for (var d = e.length, s = h(e, d), l = 0; l < d; ++l)
                s[l].call(n, r, o, a);
          }
          function c(e, t, n, r) {
            if (t) e.apply(n, r);
            ...
            if (
              ...
              i
                ? (i.newListener &&
                    ...
                    (i = e._events)),
                  (d = i[t]))
                : ((i = e._events = _(null)), (e._eventsCount = 0)),
              !d)
            )
              ...
              ('function' == typeof d
                ...
                : o
                  ? d.unshift(n)
                  : d.push(n),
              !d.warned && ((a = r(e)), a && 0 < a && d.length > a))
            ) {
              d.warned = !0;
              var s = new Error(
          ...
          C
            ...
            (n.prototype.emit = function(e) {
              var t,
                ...
                u,
                f = 'error' === e;
              if (((u = this._events), u)) f = f && null == u.error;
              else if (!f) return !1;
              if (f) {
                if (
      ...
      7: [
        function(e, t, r) {
          ...
          function a(e) {
            function t() {
              if (t.enabled) {
                ...
                for (var d = Array(arguments.length), s = 0; s < d.length; s++)
                  d[s] = arguments[s];
                (d[0] = r.coerce(d[0])),
          ...
          (r = t.exports = a.debug = a['default'] = a),
            (r.coerce = function(e) {
            ...
            (a.write = function(o, a, l, p, u, f) {
              ...
              for (
                a = n(a),
                  isNaN(a) || a === 1 / 0
                    ? ((h = isNaN(a) ? 1 : 0), (g = y))
                    : ((g = t(Math.log(a) / Math.LN2)),
                      1 > a * (_ = r(2, -g)) && (g--, (_ *= 2)),
                      (a += 1 <= g + C ? w / _ : w * r(2, 1 - C)),
                      2 <= a * _ && (g++, (_ /= 2)),
                      g + C >= y
                        ? ((h = 0), (g = y))
                        : 1 <= g + C
                          ? ((h = (a * _ - 1) * r(2, u)), (g += C))
                          : ((h = a * r(2, C - 1) * r(2, u)), (g = 0)));
                8 <= u;
                o[l + S] = 255 & h, S += v, h /= 256, u -= 8
              );
              for (
                g = (g << u) | h, b += u;
                0 < b;
                o[l + S] = 255 & g, S += v, g /= 256, b -= 8
              );
              o[l + S - v] |= 128 * d;
            });
        },
      ...
      17: [
        function(e, t) {
          ...
          d.inherits(n, s);
          for (var c, p = i(l.prototype), u = 0; u < p.length; u++)
      ...
      18: [
        ...
        { './_stream_transform': 20, 'core-util-is': 5, inherits: 10 }
      ],
      19: [
        function(e, n) {
          (function(r, o) {
            ...
            function s(n, r) {
              ...
              (this.objectMode = !!n.objectMode),
                o &&
                  (this.objectMode = this.objectMode || !!n.readableObjectMode);
              var a = n.highWaterMark,
                i = n.readableHighWaterMark,
                d = this.objectMode ? 16 : 16384;
              (this.highWaterMark =
                a || 0 === a ? a : o && (i || 0 === i) ? i : d),
                (this.highWaterMark = t(this.highWaterMark)),
                (this.buffer = new V()),
                (this.length = 0),
                (this.pipes = null),
                (this.pipesCount = 0),
            ...
            function l(t) {
              return (
                ...
                this instanceof l
                  ? void ((this._readableState = new s(t, this)),
                    (this.readable = !0),
                    t &&
            ...
            function h(e, t) {
              return 0 >= e || (0 === t.length && t.ended)
                ...
                : t.objectMode
                  ? 1
                  : e === e
                    ? (e > t.highWaterMark && (t.highWaterMark = g(e)),
                      e <= t.length
                        ? e
                        : t.ended
                          ? t.length
            ...
            function v(e, t) {
              t.resumeScheduled ||
                ((t.resumeScheduled = !0), F.nextTick(x, e, t));
            }
            function x(e, t) {
            ...
            function E(e, t) {
              ...
              for (e -= a.length; (r = r.next); ) {
                ...
                if (
                  ((a += d === i.length ? i : i.slice(0, e)), (e -= d), 0 === e)
                ) {
                  d === i.length
            ...
            function L(e) {
              ...
              t.endEmitted || ((t.ended = !0), F.nextTick(I, t, e));
            }
            function I(e, t) {
              e.endEmitted ||
                0 !== e.length ||
            ...
            Object.defineProperty(l.prototype, 'destroyed', {
              ...
              (l.prototype.destroy = G.destroy),
              (l.prototype._undestroy = G.undestroy),
            ...
            (l.prototype.read = function(e) {
              ...
              H('need readable', o),
                (0 === t.length || t.length - e < t.highWaterMark) &&
                  ((o = !0), H('length less than watermark', o)),
                t.ended || t.reading
                  ? ((o = !1), H('reading or ended', o))
                  : o &&
                    (H('do read'),
                    (t.reading = !0),
                    (t.sync = !0),
              ...
              (l.prototype.pipe = function(e, t) {
                ...
                function a() {
                  H('cleanup'),
                    ...
                    u.removeListener('end', p),
                    u.removeListener('data', i),
                    (_ = !0),
                    f.awaitDrain &&
                ...
                (f.pipesCount += 1),
                  H('pipe count=%d opts=%j', f.pipesCount, t);
                var g =
                    (!t || !1 !== t.end) && e !== r.stdout && e !== r.stderr,
                  h = g ? o : p;
                f.endEmitted ? F.nextTick(h) : u.once('end', h),
                  e.on('unpipe', n);
                var m = w(u);
                e.on('drain', m);
                var _ = !1,
                ...
                return (
                  ...
                  e.once('finish', c),
                  e.emit('pipe', u),
                  f.flowing || (H('pipe resume'), u.resume()),
                  e
                );
              }),
              ...
              (l.prototype.on = function(e, t) {
                ...
                if ('data' === e)
                  ...
                  r.endEmitted ||
                    ...
                    (r.emittedReadable = !1),
                    r.reading ? r.length && _(this) : F.nextTick(S, this));
                }
                return n;
              }),
              ...
              (l.prototype.resume = function() {
                ...
                return (
                  e.flowing || (H('resume'), (e.flowing = !0), v(this, e)), this
                );
              }),
      ...
      20: [
        ...
        { './_stream_duplex': 17, 'core-util-is': 5, inherits: 10 }
      ],
      21: [
        function(e, n) {
          (function(r, o, a) {
            ...
            function c(n, r) {
              ...
              (this.objectMode = !!n.objectMode),
                o &&
                  (this.objectMode = this.objectMode || !!n.writableObjectMode);
              var a = n.highWaterMark,
            ...
            function p(t) {
              return (
                ...
                j.call(p, this) || this instanceof L
                  ? void ((this._writableState = new c(t, this)),
                    (this.writable = !0),
                    t &&
            ...
            function f(e, t, n, r) {
              ...
              return (
                ...
                a && (e.emit('error', a), A.nextTick(r, a), (o = !1)),
                o
              );
            }
            function g(e, t, n) {
            ...
            function R(e, t) {
              t.prefinished ||
                ...
                ('function' == typeof e._final
                  ? (t.pendingcb++, (t.finalCalled = !0), A.nextTick(x, e, t))
            ...
            var L,
              I =
                !r.browser &&
                -1 < ['v0.10', 'v0.9.'].indexOf(r.version.slice(0, 5))
                  ? a
                  : A.nextTick;
            p.WritableState = c;
              ...
              ? ((j = Function.prototype[Symbol.hasInstance]),
                Object.defineProperty(p, Symbol.hasInstance, {
                  value: function(e) {
                    return (
                      !!j.call(this, e) ||
                      (!(this !== p) && e && e._writableState instanceof c)
                    );
                  }
                }))
              : (j = function(e) {
              ...
              (p.prototype.write = function(e, t, n) {
                ...
                return (
                  ...
                  r.ended
                    ? u(this, n)
                    : (a || f(this, r, e, n)) &&
                      (r.pendingcb++, (o = h(this, r, a, e, t, n))),
                  o
                );
              }),
          ...
          (t.exports = (function() {
            ...
            return (
              ...
              (e.prototype.concat = function(e) {
                ...
                for (var t = o.allocUnsafe(e >>> 0), n = this.head, a = 0; n; )
      ...
      27: [
        function(e, t, n) {
          ...
          function o(e) {
            var t = r(e);
            if ('string' != typeof t && (m.isEncoding === _ || !_(e)))
      ...
      28: [
        ...
        { 'process/browser.js': 15, timers: 28 }
      ],
      29: [
        function(e, t) {
          (function(e) {
          ...
          (function(n) {
            function r(e) {
              ...
              if (
                ...
                (t.channelName = e.initiator
                  ? e.channelName || l(20).toString('hex')
                  : null),
                (t._isChromium =
                  'undefined' != typeof window &&
                  !!window.webkitRTCPeerConnection),
                ...
                (t.localPort = void 0),
                (t._wrtc = e.wrtc && 'object' == typeof e.wrtc ? e.wrtc : d()),
                !t._wrtc)
              )
            ...
            s(r, c.Duplex),
              ...
              (r.prototype.signal = function(e) {
                ...
                t._debug('signal()'),
                  e.renegotiate &&
                    (t._debug('got request to renegotiate'),
                    t._needsNegotiation()),
                  e.candidate &&
              ...
              (r.prototype._addIceCandidate = function(e) {
                ...
                try {
                  ...
                  t.destroy(
                    o(
                      'error adding candidate: ' + e.message,
              ...
              (r.prototype.removeTrack = function(e, t) {
                ...
                try {
                  ...
                  'NS_ERROR_UNEXPECTED' === e.name
                    ? n._sendersAwaitingStable.push(o)
                    : n.destroy(e);
                }
              }),
              ...
              (r.prototype.negotiate = function() {
                ...
                e.initiator
                  ? e._isNegotiating
                    ...
                    : (e._debug('start negotiation'), e._createOffer())
                ...
                if (!n.destroyed) {
                  ...
                  if (n._pc) {
                    ...
                    (n._pc.oniceconnectionstatechange = null),
                      ...
                      'addTrack' in n._pc && (n._pc.ontrack = null),
              ...
              (r.prototype._onIceStateChange = function() {
                ...
                if (!e.destroyed) {
                  ...
                  e._debug(
                    ...
                    'closed' === t &&
                      e.destroy(new Error('Ice connection closed.'));
                }
              }),
              ...
              (r.prototype._maybeReady = function() {
                function e() {
                  t.destroyed ||
                    t.getStats(function(n, r) {
                      function a(e) {
                        l = !0;
                        var n = d[e.localCandidateId];
                        n && n.ip
                          ? ((t.localAddress = n.ip), (t.localPort = +n.port))
                          : n && n.ipAddress
                            ? ((t.localAddress = n.ipAddress),
                              (t.localPort = +n.portNumber))
                            : 'string' == typeof e.googLocalAddress &&
                              ((n = e.googLocalAddress.split(':')),
                              (t.localAddress = n[0]),
                              (t.localPort = +n[1]));
                        var r = i[e.remoteCandidateId];
                        r && r.ip
                          ? ((t.remoteAddress = r.ip), (t.remotePort = +r.port))
                          : r && r.ipAddress
                            ? ((t.remoteAddress = r.ipAddress),
                              (t.remotePort = +r.portNumber))
                      ...
                      if (!t.destroyed) {
                        ...
                        if (
                          ...
                          !l &&
                            (!Object.keys(s).length || Object.keys(d).length))
                        )
                        ...
                        if (
                          ...
                          (t._chunk = null),
                            t._debug('sent chunk from "write before connect"');
                          var c = t._cb;
                          (t._cb = null), c(null);
                        }
                        'number' !=
                          typeof t._channel.bufferedAmountLowThreshold &&
                          ((t._interval = setInterval(function() {
                            t._onInterval();
                          }, 150)),
                          t._interval.unref && t._interval.unref()),
                          t._debug('connect'),
                          t.emit('connect');
                      }
                    });
