...
var debug$c = debugLogger('MEWconnect:websocketWrapper');
...
var debug$b = debugLogger('MEWconnect:initiator-V2');
...
var debug$a = debugLogger('MEWconnect:initiator-V1');
...
var debug$9 = debugLogger('MEWconnect:wallet'); // const debugConnectionState = debugLogger('MEWconnect:connection-state');
...
var debug$8 = debugLogger('MEWconnect:webRTC-communication');
...
var debug$7 = debugLogger('MEWconnect:initiator-base');
