...
import ethUtils, { bufferToInt, bufferToHex as bufferToHex$1, publicToAddress, hashPersonalMessage, ecsign, isHexString, toBuffer as toBuffer$2, isValidPrivate, privateToPublic, isValidPublic } from 'ethereumjs-utils';
...
import utils, { isHexStrict } from 'web3-utils';
...
var debugPeer$2 = debugLogger('MEWconnectVerbose:websocketWrapper');
var debug$d = debugLogger('MEWconnect:websocketWrapper');
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                url = "".concat(websocketUrl, "?").concat(queryString.stringify(options));
                debug$d(url);
...
var debug$c = debugLogger('MEWconnect:initiator-V2');
var debugTurn = debugLogger('MEWconnect:turn-V2');
var debugStages$3 = debugLogger('MEWconnect:initiator-stages-V2');
...
var debug$b = debugLogger('MEWconnect:initiator-V1');
var debugPeer$1 = debugLogger('MEWconnectVerbose:peer-instances-V1');
var debugStages$2 = debugLogger('MEWconnect:initiator-stages-V1');
...
var image = "data:image/svg+xml,%3Csvg width='56' height='56' viewBox='0 0 56 56' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M12.9163 12.9166C14.1432 11.6896 15.8073 11.0003 17.5425 11.0003L44.9997 11V16.0201C44.9997 17.2673 44.5042 18.4635 43.6223 19.3454C42.7404 20.2273 41.5442 20.7227 40.297 20.7227H27.3876C25.6524 20.7227 23.9884 21.4121 22.7614 22.639C21.5344 23.866 20.8451 25.5301 20.8451 27.2653V28.9303C20.8451 30.6655 21.5344 32.3296 22.7614 33.5566C23.9884 34.7835 25.6524 35.4728 27.3876 35.4728H40.297C41.5442 35.4728 42.7404 35.9683 43.6223 36.8502C44.5042 37.7321 44.9997 38.9283 44.9997 40.1755V45H17.5425C15.8073 45 14.1432 44.3107 12.9163 43.0837C11.6893 41.8567 11 40.1926 11 38.4575V17.5428C11 15.8076 11.6893 14.1435 12.9163 12.9166ZM27.6704 23.459H40.9107C43.169 23.459 44.9997 25.2897 44.9997 27.548V28.6481C44.9997 30.9064 43.169 32.7372 40.9107 32.7372H27.6704C25.4121 32.7372 23.5813 30.9064 23.5813 28.6481V27.548C23.5813 25.2897 25.4121 23.459 27.6704 23.459Z' fill='url(%23paint0_linear_350_2361)'/%3E%3Cdefs%3E%3ClinearGradient id='paint0_linear_350_2361' x1='14.4173' y1='11' x2='38.2673' y2='46.5751' gradientUnits='userSpaceOnUse'%3E%3Cstop stop-color='%23C549FF'/%3E%3Cstop offset='1' stop-color='%23654BFF'/%3E%3C/linearGradient%3E%3C/defs%3E%3C/svg%3E%0A";
...
var ENKRYPT_LINK = 'https://chrome.google.com/webstore/detail/enkrypt/kkpllkodjeloidieedojogacfhpaihoh';
...
var PopUpCreator = /*#__PURE__*/function (_EventEmitter) {
  ...
  function PopUpCreator() {
    ...
    _this.logo = image$5;
    _this.spaceman = image$4;
    _this.refreshIcon = refreshIcon;
    _this.playStoreButton = image$3;
    _this.appStoreButton = image$2;
    _this.camera = image$1;
    _this.closeIconBlack = icon;
    _this.enkryptIcon = image;
  ...
  _createClass(PopUpCreator, [{
    ...
    value: function createWindowInformer() {
      ...
      div.innerHTML = windowInformer(image$4);
    ...
    value: function createQrCodeModal() {
      ...
      div.innerHTML = modalFrame(htmlDesign(this.refreshIcon, this.spaceman, this.playStoreButton, this.appStoreButton, this.camera, this.closeIconBlack, IOS_LINK, ANDROID_LINK, this.enkryptIcon, ENKRYPT_LINK)); // div.innerHTML = windowInformer(spaceman);
...
var WalletInterface = /*#__PURE__*/function () {
  ...
  _createClass(WalletInterface, [{
    ...
    value: function getPrivateKeyString() {
      if (this.isPubOnly) throw new Error('public key only wallet');
      return bufferToHex$1(this.getPrivateKey());
    }
  }, {
    key: "getNickname",
    ...
    value: function getPublicKeyString() {
      return bufferToHex$1(this.getPublicKey());
    }
  }, {
    key: "getAddress",
    ...
    value: function getAddressString() {
      return bufferToHex$1(this.getAddress());
    }
  }, {
    ...
    value: function signMessage(msg, signer) {
      ...
      return new Promise(function (resolve, reject) {
        if (!_this.isPubOnly) {
          var msgHash = hashPersonalMessage(toBuffer$1(msg));
          var signed = ecsign(msgHash, _this.privateKey);
...
var commonGenerator = function commonGenerator(network) {
  var customCommon = Common.forCustomChain('mainnet', {
...
var getService = function getService(parsableUrl) {
  var parsedUrl = url$1.parse(parsableUrl).hostname;
...
var debug$a = debugLogger('MEWconnect:wallet'); // const debugConnectionState = debugLogger('MEWconnect:connection-state');
                          ...
                          case 0:
                            ...
                            return _context.abrupt("return", new Promise(function (resolve, reject) {
                              ...
                              _this2.mewConnect.once('signTx', function (result) {
                                ...
                                tx = new Transaction(sanitizeHex$1(result), {
                        ...
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            return _context2.abrupt("return", new Promise(function (resolve, reject) {
                              var msgHash = hashPersonalMessage(misc.toBuffer(msg));
...
var PopUpHandler = /*#__PURE__*/function () {
  ...
  _createClass(PopUpHandler, [{
    ...
    value: function createNotice() {
      ...
      div.innerHTML = noticeHtml(this.elementId, image$4, icon);
      ...
      divConn.innerHTML = connectedNoticeHtml(this.connectedElementId, image$4, icon$1);
...
var debug$9 = debugLogger('MEWconnect:webRTC-communication');
var debugPeer = debugLogger('MEWconnectVerbose:peer-instances');
var debugStages$1 = debugLogger('MEWconnect:peer-stages');
...
var debug$7 = debugLogger('MEWconnectWeb3');
var debugErrors$6 = debugLogger('MEWconnectError');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 20:
            ...
            if (!(!tx.gas || new BigNumber(tx.gas).lte(0))) {
              _context.next = 28;
              break;
            }
          ...
          case 29:
            ...
            if (!(!tx.gasPrice || new BigNumber(tx.gasPrice).lte(0))) {
              _context.next = 37;
              break;
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            parts = ethUtils.fromRpcSig(payload.params[1]);

            if (!parts) {
              res(toError(payload.id, 'Invalid signature supplied to personal_ecRecover'));
            }

            recovered = ethUtils.ecrecover(ethUtils.hashPersonalMessage(misc.toBuffer(payload.params[0])), parts.v, parts.r, parts.s);
            addressBuffer = ethUtils.pubToAddress(recovered);
          ...
          case 3:
            try {
              ...
              if (!isHexStrict(jsonObj)) {
                ...
                jsonObj = bufferToHex$1(Buffer.from(JSON.stringify(jsonObj), 'utf8'));
              }
...
var debugConnectionState = debugLogger('MEWconnect:connection-state');
var debugErrors = debugLogger('MEWconnectError');
var state = {
  wallet: null
};
    ...
    value: function makeWeb3Provider() {
      ...
      try {
        if (this.runningInApp) {
          ...
          var hostUrl = url$1.parse(RPC_URL);
          var options = {
