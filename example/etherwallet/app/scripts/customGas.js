...
module.exports = [
  {
    ...
    data: '',
    msg:
      'Thank you for buying ORCA Tokens! - Share ORCA with your friends (https://www.orcaalliance.eu).'
  },
  {
    ...
    data: '',
    msg:
      'Thank you for buying TangguoTao Token! TCA is an additional value for goods transactions.'
  },
  {
    ...
    data: '',
    msg:
      'Thank you for buying Opiria PDATA! The future of personal data brokerage - share it with your friends: https://opiria.io'
  },
  {
    ...
    data: '0xabacadae',
    msg:
      'Depository Network (DEPO) Token sale - Sign Up at https://depository.network and buy your tokens.'
  },
  {
    ...
    data: '',
    msg:
      'CryptFillCoin (CFC) token sale - Sign Up at https://cryptfillcoin.com and buy your tokens.'
  },
  {
    ...
    data: '',
    msg:
      'MTC Mesh Network (MTC) token sale - Sign Up at https://www.mtc.io/ and buy your tokens.'
  },
  {
    ...
    data: '',
    msg:
      'Ethernet.Cash (ENC) token sale - https://ethernet.cash get up to 50% bonus and 50% for your referral.'
  },
  {
    ...
    data: '',
    msg:
      'Merculet (MVP) token sale - You must have registered at https://merculet.io and followed the instructions to purchase tokens here.'
  },
  {
    ...
    data: '',
    msg:
      'GIFcoin (GIF) token sale - https://gifcoin.io - save your ETH wallet after purchase on the website to gain access to investors hub.'
  },
  {
    // AX1 Mining token
    ...
    data: '',
    msg:
      'You must have registered at https://ax1.io and followed the instructions to purchase tokens here.'
  },
  {
  ...
  },
  {
    ...
    data: '',
    msg:
      'DAV Token Sale - Must register on https://dav.network/ first to participate'
  },
  {
  ...
  },
  {
    ...
    data: '',
    msg:
      'J8T Token Sale - https://jet8.io/token - JET8 · Democratizing influence'
  },
  {
    // PUC Token Sale
  ...
  },
  {
    ...
    data: '',
    msg:
      'BMChain ICO - Platform of digital reputation - Official site https://bmchain.io'
  },
  {
    // TBOT Token Sale
  ...
  },
  {
    ...
    data: '',
    msg:
      'SIRIN LABS official crowdsale address. Official website https://sirinlabs.com'
  },
  {
    // TRV Token Sale
  ...
  },
  {
    ...
    data: '',
    msg:
      'LiveEdu LEDU token sale. Official website: https://tokensale.liveedu.tv/'
  },
  {
    ...
    data: '',
    msg:
      'HEdpAY (Hdp.ф) sale. Official sale website: https://ibiginvestments.com/hedpay'
  },
  {
    ...
    data: '',
    msg:
      'COPYTRACK (CPY) Token Sale. Official sale website: https://copytrack.io'
  },
  {
    ...
    data: '',
    msg:
      'DoBetAcceptBet (DCA) Token Sale. Official sale website: https://dobetacceptbet.com'
  },
  {
  ...
  },
  {
    ...
    data: '',
    msg:
      'LALA World Token (LALA) Token Sale. Official sale website: https://lalaworld.io'
  },
  {
    ...
    data: '',
    msg:
      'Digital Asset Exchange Token (DAXT) Token Sale. Official sale website: https://www.daxt.io'
  },
  {
  ...
  },
  {
    ...
    data: '',
    msg:
      'WhoHas-Token Sale. Please register through our official website: https://whohas.io/'
  },
  {
    // WHEN (￦) Token Sale
    ...
    data: '',
    msg:
      'WHEN Token Sale. Join the future of person-to-person micro-contracts using the blockchain.: https://interface.whenhub.com/'
  },
  {
  ...
  },
  {
    ...
    data: '',
    msg:
      'Brickblock (BBK) Token Sale. Official sale website:https://www.brickblock.io'
  },
  {
