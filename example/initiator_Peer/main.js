...
let mewConnect = new MewConnect(signalStateChange, logger, {wrtc: MewRTC, cryptoImpl: new MewConnectCrypto(CCrypto.crypto, CCrypto.secp256k1, EthUtilities, BBuffer.Buffer), io: io, ethUtils: ""});
...
function initiateSocketConnection() {
    ...
    mewConnect.initiatorStart(`https://${urlBase}:3001`);
}
