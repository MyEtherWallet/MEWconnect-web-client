...
axios.get('/configValues')
  .then(_response => {
    ...
    window.configValues = _response.data.receiver
  })
// ----------------------------------------
...
function connect (code) {
  ...
  if (configValues.port) {
    mewConnect.receiverStart(`${configValues.proto}://${configValues.host}:${configValues.port}`, options)
  } else {
    mewConnect.receiverStart(`${configValues.proto}://${configValues.host}`, options)
  }
}
